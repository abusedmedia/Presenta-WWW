        ...
        <div class="columns">
            ...
            <div class="left">
                <div class="incipit">
                    ...
                    <h4>Meme Generation</h4>

                    <h2>Generate Personalized Memes upon User interaction.</h2>

                    <p>Engage users with personalized meme generated on user 'Following', 'Reply' or 'Comment' interaction.</p>
...
export default {
    ...
    data(){
        return {
            images:[
                {
                    a:'https://cloud.presenta.cc/v1/url/zGywhb2oJn:HpjEHTWyL?&name=SomeUserName',
                    b:'https://cloud.presenta.cc/v1/url/zGywhb2oJn:HpjEHTWyL?&name=OtherName',
                    c:'https://cloud.presenta.cc/v1/url/zGywhb2oJn:HpjEHTWyL?&name=AlternativeName'
                },
                {
