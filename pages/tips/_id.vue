...
export default {
    ...
    async asyncData({ params }) {
        ...
        let cnt = await import(`~/content/tips/${params.id}.md`)
    ...
    head () {
        ...
        return {
            ...
            meta: [
                ...
                { hid:'ogurl', property: 'og:url', content: `https://www.presenta.cc/tips/${this.slug}` },
                { hid:'twurl', name: 'twitter:url', content: `https://www.presenta.cc/tips/${this.slug}` }
            ]
        }
    },
    computed:{
